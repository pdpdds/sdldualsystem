#ifndef _THE_GOONIES_OBJECT_TRICKYSKULL
#define _THE_GOONIES_OBJECT_TRICKYSKULL

class GO_trickyskull : public GO_skull
{
    public:
        GO_trickyskull(int x, int y, int sfx_volume, int facing);
