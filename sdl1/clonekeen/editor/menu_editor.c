...
extern void editor_resetmap(void);
extern void editor_addborder(void);
extern void editor_exit(void);
extern void editor_nextep(void);
extern void editor_saveas(void);
extern void editor_resizemap(void);
extern void editor_settimelimit(void);
