	...
	if (replay_fp != 0) {
		if (replay_cycle == 0) {
			...
			/* date: */
			{
				...
				fputc(today.wYear, replay_fp);
				fputc(today.wMonth, replay_fp);
				fputc(today.wDay, replay_fp);
				fputc(today.wHour, replay_fp);
				fputc(today.wMinute, replay_fp);
				fputc(today.wSecond, replay_fp);
