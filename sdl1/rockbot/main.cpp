...
#include <iostream>
#include <SDL.h>				//Include da SDL
#include <SDL_image.h>		//Include da biblioteca SDL_Image
#include <SDL_mixer.h>	// Include da biblioteca SDL_Mixer
#include <SDL_ttf.h>		// Include da biblioteca SDL_ttf
