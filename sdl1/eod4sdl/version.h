...
#define FIXRAINSNOWLEAKS

#define HIDEMENUSTUFF
#define NEWMENU
#define CRAND
#define CHRISRULES // (new overhead map)
//#define MOUSEWHEEL
#define VARIABLEWEATHER
#define EODSPECIAL // special hard coded features specific to EOD like "Greed"
#define REVEALMAP
