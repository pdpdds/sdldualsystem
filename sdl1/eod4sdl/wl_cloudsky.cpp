...
colormapentry_t colmapents_1[] = { { 4, -31 }, {3 , -255}  };
...
void DrawClouds(byte *vbuf, unsigned vbufPitch, int min_wallheight)
{
    ...
    top_offset0 = vbufPitch * (halfviewheight - y0 - 1);

    // draw horizontal lines
    for(int y = y0, top_offset = top_offset0; y < halfviewheight; y++, top_offset -= vbufPitch)
    {
