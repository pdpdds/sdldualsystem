...
#define BORD2COLOR      0x1a
#define DEACTIVE        0x1d
#define BKGDCOLOR       0x1c
//#define STRIPE                0x9c
...
#define VIEWCOLOR       0x1d
#define TEXTCOLOR       0x17

#define MSGBGCOLOR      0x17
#define MSGFONTCOLOR    0x00
#define MSGSHADOWCOLOR  0x00

#define HIGHLIGHT       0x13
#define MenuFadeIn()    VL_FadeIn(0,255,gamepal,10)


#define MENUSONG        XDEATH_MUS

#ifndef SPEAR
#define INTROSONG       NAZI_NOR_MUS
#else
#define INTROSONG       XEVIL_MUS
#endif
...
#define GOP_Y   20
#define GOP_W   284
#define GOP_H   13*(NUMSWITCHES+2)-4 
...
#ifdef NEWMENU
int CP_GameOptions(int);
void DrawGOPScreen(void);
#endif
...
#else
enum {KEYBOARDBTN,MOUSEBTN,JOYSTICKBTN};
#endif
