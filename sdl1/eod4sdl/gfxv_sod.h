...
#define LATCHPICS_LUMP_START    GRINPIC
#define LATCHPICS_LUMP_END		FS_KEY4PIC

#define GOP_LUMP_START          C_VISUALSPIC
#define GOP_LUMP_END            C_MISCPIC
...
#define NUMFONT      2
#define NUMFONTM     0
#define NUMPICS      (C_MISCPIC- NUMFONT)
#define NUMPICM      0
#define NUMSPRITES   0
#define NUMTILE8     72
#define NUMTILE8M    0
