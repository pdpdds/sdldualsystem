...
int	    px,py;
byte	fontcolor,backcolor,shadcolor;
int	    fontnumber;
boolean pSpacing = false;
...
void LatchDrawPicScaledCoord2 (unsigned scx, unsigned scy, unsigned picnum)
{
	VL_LatchToScreenScaledCoord (latchpics[2+picnum-LATCHPICS_LUMP_START], scx, scy);
}
