...
class Audio {
 public:
  ...
  void NextMusic(void);    // Passe ?la music suivante
  ...
  /*** Variables ***/
  int N; // Nombre d'?hantillon audio
  int NMus; // Num?o de la music en cours
  int MemoHorloge; // M?orise l'horloge pour les clics
