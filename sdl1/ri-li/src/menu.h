...
class Menu {
 public:
  ...
  void InitMain_Options(void);   // Pr?are l'affichage du menu options
  eMenu SDLMain_Options(void);  // Menu du choix des options
  eMenu SDLMain_Speed(void);  // Menu du choix de la difficult?  
  ...
  void Affiche_Main_Centre(void);          // Centre les fl?hes sur le bouton

  /*** Variables ***/
  /*****************/
  int PyE; // Position du curseur dans le menu
  int NumEc; // Num?o de l'ecran en cours d'affichage
  int Niv;
