//      (_||_/       Utils.h
//      (    )       Fonctions divers pour les differents syst?es d'exploitation
//     ( o  0 )
//-OOO?-(_)---°OOO---------------------------------------
...
long ChargeFichier(const char *Path,unsigned char *&Buf); // Charge un ficher en m?oire
...
bool LoadPref(void); // Charger les pr?erences
