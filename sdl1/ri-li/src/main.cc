...
/*** Variables globales ***/
/************************/
SDL_Surface* sdlVideo; // Pointe sur l'?ran video
SDL_VideoInfo* sdlVideoInfo; // Infos sur la video
Uint32 FontColor;      // Couleur du fond d'?ran

char Titre[] = "Ri-li V2.0.1";

Sprite* Sprites = NULL; // Pointe sur les sprites
int NSprites = 0; // Nombre de sprites en m?oire
Ecran Ec[2];          // Pointe sur les 2 buffets vid?
sPreference Pref;     // Tableau des pr??ences.
Jeux Jeu;             // G?e le jeu
Mouse Sourie;         // G?e les mouvements de sourie
Menu MenuPrincipale;  // G?e les menus
Tableau Niveau;       // G?e les niveaux
Editeur Edit;         // G?e le menu de l'?iteur
Audio Sons;           // G?e les sons
